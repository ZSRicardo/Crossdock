...
namespace Crossdock.Controllers
{
    ...
    {
        private TablaTipoEntregasCommands objTipoEntregas = new TablaTipoEntregasCommands();//llamada de clase
        ...
        public JsonResult Listaentregas()
        {
            var lista = objTipoEntregas.Muestra_TipoEntregas().ToList();
            lista = indice_general(lista);
            return Json(new { data = lista }, JsonRequestBehavior.AllowGet);
        }

        private List<TipoEntregas> indice_general(List<TipoEntregas> lista)
        {
            int indice = 1;
        ...
        public ActionResult Details(string id)
        {
            ...
            var list = objTipoEntregas.Muestra_TipoEntregasMod(id2).ToList();//consumo de sp
            var tipoEntregas = new TipoEntregas //asiga los valores del model para el muestreo 
            {
                TipoEntregasID = list[0].TipoEntregasID,
                Descripcion = list[0].Descripcion,
            };
            return View(tipoEntregas);
        }
        ...
        public ActionResult Create()
        {
            ...
            _ = objTipoEntregas.Muestra_TipoEntregas().ToList();//consumo de sp
            return View();
        }
        ...
        public ActionResult Create(TipoEntregas entregas)
        {
            //* Modelo invalido
            ...
            var list = new TipoEntregas
            {
                TipoEntregasID = 0,
                Descripcion = entregas.Descripcion,
            };

            // SP para alta/modificacion de destinatario
            objTipoEntregas.Alta_TipoEntregas(list);
        ...
        public ActionResult Edit(string id)
        {
            ...
            var list = objTipoEntregas.Muestra_TipoEntregasMod(id2).ToList();
            var entregas = new TipoEntregas
            {
                TipoEntregasID = list[0].TipoEntregasID,
                Descripcion = list[0].Descripcion,
            };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(TipoEntregas entregas)
        {
            if (ModelState.IsValid)
            {
                objTipoEntregas.Alta_TipoEntregas(entregas);
                return RedirectToAction("Index");
            }
            return View(entregas);
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            var list = objTipoEntregas.Muestra_TipoEntregasMod(id2).ToList();//consumo de sp
            var entregas = new TipoEntregas //asiga los valores del model para el muestreo 
            {
                TipoEntregasID = list[0].TipoEntregasID,
                Descripcion = list[0].Descripcion,
            };
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            id = JsonConvert.DeserializeObject<string>(id);
            var id2 = Convert.ToInt32(id);
            objTipoEntregas.Elimina_TipoEntregas(id2);
            return RedirectToAction("Index");
            }
            catch (Exception ex)
            {
