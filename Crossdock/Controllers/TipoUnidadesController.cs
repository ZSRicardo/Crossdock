...
namespace Crossdock.Controllers
{
    ...
    {
        private TablaTipoUnidadesCommands objTipoUnidades = new TablaTipoUnidadesCommands();//llamada de clase
        ...
        {
            var lista = objTipoUnidades.Muestra_TipoUnidades().ToList();
            lista = indice_general(lista);
            return Json(new { data = lista }, JsonRequestBehavior.AllowGet);
        }

        private List<TipoUnidades> indice_general(List<TipoUnidades> lista)
        {
            int indice = 1;
        ...
        public ActionResult Details(string id)
        {
            ...
            var list = objTipoUnidades.Muestra_TipoUnidadesMod(id2).ToList();//consumo de sp
            var tipoUnidad = new Models.TipoUnidades //asiga los valores del model para el muestreo 
            {
        ...
        public ActionResult Create()
        {
            ...
            SeparaPermisos(Session["Permisos"].ToString());
            _ = objTipoUnidades.Muestra_TipoUnidades().ToList();//consumo de sp
            return View();
        }
        ...
        public ActionResult Create(TipoUnidades unidad)
        {
            //* Modelo invalido
            ...
            var Tipounidad = new TipoUnidades
            {
                TipoUnidadID = 0,
            ...
            objTipoUnidades.Alta_TipoUnidades(Tipounidad);
        ...
        public ActionResult Edit(string id)
        {
            ...
            var list = objTipoUnidades.Muestra_TipoUnidadesMod(id2).ToList();
            var TipoUnidades = new TipoUnidades
            {
                TipoUnidadID = list[0].TipoUnidadID,
                Descripcion = list[0].Descripcion,
            };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(TipoUnidades tipounidades)
        {
            if (ModelState.IsValid)
            {
                objTipoUnidades.Alta_TipoUnidades(tipounidades);
                return RedirectToAction("Index");
            }
            return View(tipounidades);
        }
        ...
        public ActionResult Delete(string id)
        {
            ...
            var list = objTipoUnidades.Muestra_TipoUnidadesMod(id2).ToList();//consumo de sp
            var tipoUnidades = new TipoUnidades //asiga los valores del model para el muestreo 
            {
                TipoUnidadID = list[0].TipoUnidadID,
                Descripcion = list[0].Descripcion,
            };
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            id = JsonConvert.DeserializeObject<string>(id);
            var id2 = Convert.ToInt32(id);
            objTipoUnidades.Elimina_TipoUnidades(id2);
            return RedirectToAction("Index");
            }
            catch (Exception ex)
            {
