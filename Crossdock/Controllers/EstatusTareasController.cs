...
{
    public class EstatusTareasController : Controller
    {
        private TablaEstatusTareasCommands objEstTareas = new TablaEstatusTareasCommands();//llamada de clase
        ...
        {
            var lista = objEstTareas.Muestra_EstatusTareas().ToList();
            lista = indice_general(lista);
            return Json(new { data = lista }, JsonRequestBehavior.AllowGet);
        }

        private List<EstatusTareas> indice_general(List<EstatusTareas> lista)
        {
            int indice = 1;
        ...
        public ActionResult Details(string id)
        {
            ...
            else
            {
                ...
                var list = objEstTareas.Muestra_EstatusTareasMod(id2).ToList();//consumo de sp
                var est = new EstatusTareas //asigna los valores del model para el muestreo 
                {
        ...
        public ActionResult Create()
        {
            ...
            SeparaPermisos(Session["Permisos"].ToString());
            _ = objEstTareas.Muestra_EstatusTareas().ToList();
            return View();
        }

        // POST: EstatusTareas/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que quiere enlazarse. Para obtener 
        // más detalles, vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(EstatusTareas estatustareas)
        {
            ...
            var est = new EstatusTareas
            {
                EstatusTareasID = 0,
                Descripcion = estatustareas.Descripcion,
            };

            // SP para alta/modificacion de destinatario
            objEstTareas.Alta_EstatusTareas(est);
            return RedirectToAction("Index", new { area = "" });
        }

        // GET: EstatusTareas/Edit/5
        public ActionResult Edit(string id)
        {
            ...
            else
            {
                ...
                var list = objEstTareas.Muestra_EstatusTareasMod(id2).ToList();
                var est = new EstatusTareas
                {
                    Descripcion = list[0].Descripcion,
                };
        ...
        // POST: EstatusTareas/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que quiere enlazarse. Para obtener 
        // más detalles, vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(EstatusTareas estatusTareas)
        {
            if (ModelState.IsValid)
            {
                objEstTareas.Alta_EstatusTareas(estatusTareas);
                return RedirectToAction("Index");
            }

            return View(estatusTareas);
        }

        // GET: EstatusTareas/Delete/5
        public ActionResult Delete(string id)
        {
            ...
            else
            {
                ...
                var list = objEstTareas.Muestra_EstatusTareasMod(id2).ToList();//consumo de sp
                var est = new EstatusTareas //asiga los valores del model para el muestreo 
                {
                    EstatusTareasID = list[0].EstatusTareasID,
                    Descripcion = list[0].Descripcion,
                };
                return View(est);
                }
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            id = JsonConvert.DeserializeObject<string>(id);
            var id2 = Convert.ToInt32(id);
            objEstTareas.Eliminar_EstatusTareas(id2);
            return RedirectToAction("Index");
            }
            catch (Exception ex)
            {
